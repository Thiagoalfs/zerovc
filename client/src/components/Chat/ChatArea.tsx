...
export const ChatArea: React.FC = () => {
  ...
  return (
    <div className="flex-1 bg-background-dark flex flex-row h-full overflow-hidden">
      {/* Center Chat View */}
          ...
          <div className="flex items-center gap-4 text-gray-400">
            <button
              ...
              className={`p-1 rounded transition-colors ${
                showMemberList ? 'text-gray-100 bg-white/10' : 'text-gray-400 hover:text-gray-200'
              }`}
