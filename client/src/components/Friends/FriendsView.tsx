    ...
    <div className="flex-1 bg-background-dark flex flex-col h-full overflow-hidden select-none">
      ...
      <div className="h-14 md:h-12 border-b border-black/20 px-2 sm:px-4 md:px-6 flex items-center gap-1.5 sm:gap-3 md:gap-6 shadow-sm z-10 overflow-x-auto no-scrollbar">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 text-gray-200 font-bold pr-2 sm:pr-3 border-r border-white/10 flex-shrink-0">
          ...
          <span className="truncate text-[17px] md:text-base font-bold">Amigos</span>
        </div>
        ...
        <div className="flex items-center gap-1 sm:gap-2 text-xs md:text-sm flex-nowrap flex-shrink-0">
          ...
          <button
            ...
            className={`hidden md:flex px-2.5 py-1 rounded-lg font-semibold whitespace-nowrap transition-colors items-center gap-1.5 flex-shrink-0 ${
        ...
        {(activeTab === 'online' || activeTab === 'all') && (
          <div className="max-w-3xl space-y-2">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                onClick={() => setActiveTab('add')}
                className="md:hidden px-2.5 py-1 rounded-lg font-semibold text-xs transition-colors flex items-center gap-1.5 bg-online text-white hover:bg-online/90 shadow-sm active:scale-95"
              >
                <UserPlus className="w-3.5 h-3.5" />
