...
export const VoiceConnectionPopout: React.FC<VoiceConnectionPopoutProps> = ({
  ...
  return (
    <div
      ref={popoutRef}
      className="absolute bottom-[calc(100%+8px)] left-2 z-50 w-[290px] bg-[#111214] text-gray-200 border border-[#232428] rounded-xl shadow-2xl overflow-hidden flex flex-col font-sans select-none animate-in fade-in zoom-in-95 duration-150"
